...
class Wordpress(SuccessMessages, Config):
    ...
    def detect_wordpress_plugins(url: str):
        def check_vulns(plugin_name: str):
            ...
            response = requests.get("https://services.nvd.nist.gov/rest/json/cves/2.0?keywordSearch={}".format(plugin_name))
    ...
    def detect_directory_listing(url: str):
        ...
        print(ErrorMessages.NO_WORDPRESS_DIRECTORY_LISTING)
