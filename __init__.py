...
"""
    ...
    Also checksum, thank you! You have helped me with this prodject and helped me learn python to it's fullest. I couldn't ask for a better friend like you so big thanks.
    ...
    charge, hey man it's been a while you used to be my best friend but we driffted and I hope we will talk soon. I know you follow my prodjects on github so if you ever read this thank you!
...
class _:
    ...
    def check_file_age(self: object) -> None:
